    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Nocompetitividade</h5>
           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        <label for="competitividad"></label>
                        <input wire:model="competitividad" type="text" class="form-control" id="competitividad" placeholder="Competitividad">@error('competitividad') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
...
<div wire:ignore.self class="modal fade" id="updateDataModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Nocompetitividade</h5>
                <button wire:click.prevent="cancel()" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
