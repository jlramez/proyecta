								...
								<td width="90">
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a class="dropdown-item" wire:click="VVE({{$row->id}})"><i class="fa fa-calculator"></i> Sumar </a></li>
											<li><a data-bs-toggle="modal" data-bs-target="#updateDataModal" class="dropdown-item" wire:click="edit({{$row->id}})"><i class="fa fa-edit"></i> Editar </a></li>
											<li><a class="dropdown-item" onclick="confirm('Confirm Delete Partido id {{$row->id}}? \nDeleted Partidos cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Eliminar </a></li>  
										</ul>
									</div>								
								</td>
							</tr>
